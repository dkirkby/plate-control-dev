...
fvc.scale = 0.15548 # mm/pixel (update um_scale below if not in mm)
fvc.rotation = 0  # deg
um_scale = 1000 # um/mm
...
log_suffix = 'arc_calibration' # string gets appended to filenames -- useful for user to identify particular tests
