...
LOOPS=3 #15 #Number of times to move randomly then do XY test (DESI-doc-1985-v2)
...
points_file = 'posXY_points_test.txt' #file generated by generate_random_move
...
acc_test=xyaccuracy_test.AccuracyTest(ptl,m)
