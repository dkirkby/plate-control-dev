...
didnotmove_tol = 0.070 # Margin for how close to old move a positioner needs to be to be considered "nonmoving"
didnotmove_check_tol = 0.100 # Margin for how far off tracking needs to be to check for non motion
