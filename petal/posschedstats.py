...
class PosSchedStats(object):
    ...
    def summarize_all(self):
        ...
        data['calc: num targets not achieved - num frozen (should be zero)'] = [data['n requests accepted'][i] - data['n tables achieving requested-and-accepted targets'][i] - data['freeze'][i] for i in range(nrows)]
        return data, nrows
