...
class SendExecCases(object):
    ...
    def __init__(self):
        ...
        self.defs = {
            ...
            self.PARTIAL_SEND:   self.send_fail_return_format,  # any returned pos are in the failed-but-not-required category
            self.FAIL_SEND:      self.send_fail_return_format,  # return collections will contain some *required* pos for which tables failed to send
            ...
            self.FAIL_MOVERATE:  self.rate_fail_return_format,
            self.FAIL_RESETRATE: self.rate_fail_return_format,
    ...
    def validate(self, pc_response):
        ...
        expected_fmt = self.cases[errstr]
...
# so you only have to initialize this once
