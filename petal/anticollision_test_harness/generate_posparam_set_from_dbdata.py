...
output_file = 'posparams_10001.csv'

data_folder = 'C:/Users/joe/Desktop/anticollision targets'
calibdb_name = 'PTL01 online calib db, retrieved 2020-07-16.csv'
movesdb_name = 'PTL01 online moves db, retrieved 2020-07-16.csv'
