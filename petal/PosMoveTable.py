class PosMoveTable(object):
    ...
    def __init__(self, posmodel=PosModel.PosModel()):
        ...
        self.__rows = [] # internal representation of the data
    ...
    def for_scheduler(self):
        ...
        Does not include extra submoves.
        """
        # note to self... always return the quantized obs vals
        
    def for_scheduler_with_submoves(self):
        """Simliar to for_scheduler, but before returning the table, any
        rows with submoves for anti-backlash or final precision creep are
        appropriately modified, and the extra submove rows are added.
        """
        # note to self... always return the quantized obs vals
    ...
    def for_hardware(self):
        ...
        Always includes any submoves for anti-backlash or final precision creep.
        """
        
    # setters
    def set_move_in_obs_degrees(self, rowidx, axisid, distance, speed_mode):
        """If row index does not exist yet, then it will be added.
        """
        
    def set_move_in_motor_steps(self, rowidx, axisid, nsteps, speed_mode):
        
    def set_pause(self, rowidx, axisid, pause):
        
    def set_antibacklash_mode(self, rowidx, axisid, onoff):
        
    def set_finalcreep_mode(self, rowidx, axisid, onoff):
...
class PosMoveRow(object):
    ...
    def defaultrow():
        return {'obs_dT_continuous'  :0,        # [deg] ideal theta distance to move (as seen by external observer)
                ...
                'pause'              :0,        # [sec] delay for this number of seconds, after any moves have completed
