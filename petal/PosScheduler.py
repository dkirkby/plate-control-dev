...
class PosScheduler(object):
	...
	def schedule_moves(Qstart,Pstart,Qtarg,Ptarg,anticollision_on):
         ...
         if anticollision_on:
             move_tables_ideal = __schedule_with_anticollision(Qstart,Pstart,Qtarg,Ptarg)
         else:
             move_tables_ideal = __schedule_without_anticollision(Qstart,Pstart,Qtarg,Ptarg)
     ...
     # internal methods    
     def __schedule_without_anticollision(Qstart,Pstart,Qtarg,Ptarg):
     ...
     def __schedule_with_anticollision(Qstart,Pstart,Qtarg,Ptarg):
