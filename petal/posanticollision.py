...
class PosAnticol:
    '''
    This class contains all variables relevant to anticollision of positioners
    and operates on posschedule requests. 
    
    Input to the init function: 
    avoidance  string     default is 'EM' which uses a force law to avoid 
