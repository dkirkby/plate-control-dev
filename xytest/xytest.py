...
class XYTest(object):
    ...
    def __init__(self,hwsetup_conf='',xytest_conf='',USE_LOCAL_PRESETS=False):
        ...
        ptl = petal.Petal(ptl_id, posids=[],fidids=[],simulator_on=self.simulate, sched_stats_on=True,printfunc=self.logwrite, collider_file=self.xytest_conf['collider_file'],db_commit_on=db_commit_on, anticollision=self.xytest_conf['anticollision'])
