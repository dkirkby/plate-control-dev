...
test_path = ('/home/msdos/focalplane/fp_settings/test_settings/')
...
class XYTest(object):
    ...
    def __init__(self,opt = 'xytest',svn_user, svn_pass:
        ...
        hwsetup_conf = hwsetup_path + 'hwsetup_petal0_xytest.conf'
        self.hwsetup_conf = configobj.ConfigObj(hwsetup_conf,unrepr=True,encoding='utf-8')
        if self.opt == 'xytest':
            xytest_conf = test_path + 'xytest_ptl_clean.conf'
        elif self.opt == 'grid':
            xytest_conf = test_path + 'xytest_ptl_calib.conf'
...
if __name__=="__main__":
    svn_user = 'parkerf'
    svn_pass = 'xxx'
    test = InitHwSetup(svn_user, svn_pass)
    test.init_hwsetup()
