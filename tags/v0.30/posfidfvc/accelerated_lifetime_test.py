...
loops = 14 #Number of times to move randomly then do XY test (DESI-doc-1985-v2)
...
accuracy_test() #Do initial XY_test
for i in range(loops):
    ...
    for j in range(len(move_list)):
        ...
        m.move(life_moves[j])
    print('Starting accuracy test', i+2, 'of', loops+1)
    accuracy_test() #Check accuracy