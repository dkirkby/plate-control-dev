...
p.state.write('OFFSET_X',45.46179497)
p.state.write('OFFSET_Y',16.3852483)
p.state.write('POS_T',162.6957839)
p.state.write('POS_P',94.82387726)
p.state.write('LENGTH_R1',3.042088442)
p.state.write('LENGTH_R2',3.218954992)
p.state.write('PHYSICAL_RANGE_T',394.7359236)
p.state.write('PHYSICAL_RANGE_P',190)
p.state.write('OFFSET_T',166.3062861)
p.state.write('OFFSET_P',48.5717133)
...
p.state.write('POS_T',163.1739089)
p.state.write('POS_P',92.94576171)
...
p.state.write('OFFSET_X',37.68168412)
p.state.write('OFFSET_Y',32.25478013)
p.state.write('POS_T',163.3687445)
p.state.write('POS_P',116.9721255)
p.state.write('LENGTH_R1',3.032830929)
p.state.write('LENGTH_R2',3.129230529)
p.state.write('PHYSICAL_RANGE_T',396.6787087)
p.state.write('PHYSICAL_RANGE_P',186.5237842)
p.state.write('OFFSET_T',20.35307464)
p.state.write('OFFSET_P',-0.443724171)
...
p.state.write('OFFSET_X',75.81364258)
p.state.write('OFFSET_Y',16.72705972)
p.state.write('POS_T',-178.2212597)
p.state.write('POS_P',90.64736057)
p.state.write('LENGTH_R1',3.016980392)
p.state.write('LENGTH_R2',3.066085918)
p.state.write('PHYSICAL_RANGE_T',395.5186039)
p.state.write('PHYSICAL_RANGE_P',184.5664236)
p.state.write('OFFSET_T',-107.8929736)
p.state.write('OFFSET_P',1.242193496)
...
p.state.write('OFFSET_X',75.49844874)
p.state.write('OFFSET_Y',48.74102166)
p.state.write('POS_T',-166.4920161)
p.state.write('POS_P',87.73812282)
p.state.write('LENGTH_R1',3.023220709)
p.state.write('LENGTH_R2',3.159322408)
p.state.write('PHYSICAL_RANGE_T',392.0768472)
p.state.write('PHYSICAL_RANGE_P',184.6443874)
p.state.write('OFFSET_T',-94.62441191)
p.state.write('OFFSET_P',-5.044591386)
