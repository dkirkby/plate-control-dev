...
const uint32_t		buffer_size									=  4000; //5000; //2000; //15360;					 	// Buffer size in words. 5120 words = 20480 Bytes = 20KB. 
  ...
  can_Init (); 	// initialize CAN interface 
	...
	for (n=0; n<number_of_parts; n++){
		...
		for (p=0; p< buffer_size; p++){				// for all packets in part n
			...
			//send_CANmsg(pos_id, 8, p, buffer_size);
