...
if __name__ == '__main__':
	...
	errors=0
	n_trials = 1
	for count in range(0,n_trials):
		#canids = list(range(1,51))
		#canids.remove(3)
		#canids.remove(29)
		canids = [20000]
...
#		time.sleep(0.5)
		...
		hex_file_name = str(sys.argv[1]) #'fw31.hex'
		bc=BootLoadControl()
		...
		for value in verification_dict.values():
			if value != 'OK':
				errors += 1
		print('Count: ', count)
		print('Errors so far: %d'%(errors))
