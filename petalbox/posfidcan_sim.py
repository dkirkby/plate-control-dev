...
class PosFidCAN(object):
	...
	def __init__(self, channel='can0'):
		...
		datestr = mydate.strftime('%y%m%d-%H%M%S')
		self.fh=open("canlog_"+datestr+".log",'w+')
		self.fh.write("CAN log - created by posfidcan_sim.")
		self.fh.write(datestr)
		return
	
	def send(*args):
		"""
			print to the canlog  log file. This replaces the s.send socket call
		"""	
