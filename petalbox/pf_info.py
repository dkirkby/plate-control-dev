# pf_info.py
# This script provides readout of CAN address, silicon ID and software revision
# for positioners and fiducials
# 
# Revision History
# 
# 170320 created IG/MS 
...
if __name__ == '__main__':
	...
	loop=True
	while loop:
		print("\nEnter CAN ID and press enter:")
		print("(Enter any non-numeric key to exit)")
